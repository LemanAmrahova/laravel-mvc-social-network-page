...
@section('content')
    ...
    <div class="row">
        <div class="text-end mt-2">
            <div><a href="{{ route('posts.create') }}" class="btn btn-primary">Add Post</a></div>
            <br>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                {{ substr($post->content, 25) }}
                                        ...
                                        <a href="#" onclick="togglePostContent({{ $post->id }}); return false;"
                                           id="showMoreLink{{ $post->id }}">Show more</a>
                                        <a href="#" onclick="togglePostContent({{ $post->id }}); return false;"
                                           style="display: none;" id="showLessLink{{ $post->id }}">Show less</a>
                                @else
                                    {{ $post->content }}
                                @endif
                                ...
                                <div class="card-footer">
                                    ...
                                    <div class="float-left">
                                        <p>Comments: {{ $post->comments->where('is_deleted', false)->count() }}<a
                                                href="{{ route('posts.details', $post->id) }}"><i
                                                    class="fas fa-comments"></i></a></p>
